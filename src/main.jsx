...
import {
  DesignPatterns,
  CustomHooks,
  ChildrenComponentsDesignPattern,
  CompoundComponents,
  ExposeFunctionalityThroughRef,
} from "./routes/DesignPatterns";
import { Other, BlobDownload, Rerenders } from "./routes/Other";

const router = createBrowserRouter([
  { path: "/", element: <StartPage /> },
  { path: "/styling", element: <Styling /> },
  {
    path: "/styling/vanilla-css-not-scoping",
    element: <VanillaCSSNotScoping />,
  },
  ...
  {
    path: "/hooks/usestate-initial-render",
    element: <UseStateInitialRender />,
  },
  ...
  {
    path: "/design-patterns/compound-components",
    element: <CompoundComponents />,
  },
  {
    path: "/design-patterns/children-components-design-pattern",
    element: <ChildrenComponentsDesignPattern />,
  },
  {
    path: "/design-patterns/expose-functionality-through-ref",
    element: <ExposeFunctionalityThroughRef />,
  },
  { path: "/other", element: <Other /> },
  { path: "/other/blob-download", element: <BlobDownload /> },
  { path: "/other/re-renders", element: <Rerenders /> },
]);
